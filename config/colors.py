...
BUTTON_FOREGROUND = PRIMARY_UI_PALETTE["BLACK"]
BUTTON_HOVER = SECONDARY_PALETTE["LIGHT_TEAL"]
BUTTON_CLICK = SECONDARY_PALETTE["DARK_TEAL"]
BUTTON_DISABLED = PRIMARY_UI_PALETTE["LIGHTER_GRAY"]
